  ...
  return (
    <div className="navigation-main-wrapper">
      <div className="navigation-second-wrapper">
        ...
        <Link to="/"><h1 className="navigation-first-heading">Home</h1></Link>  
          <Link to="/pricing"><h1 className="navigation-second-heading">Pricing</h1></Link> 
          <h1
          ...
          >
            ...
            >
              <Link to="/about" className="d-flex justify-content-between header-about-heading">
              <h1>About Us</h1>
                <img src={arrow} />
              </Link>
              <div className="d-flex justify-content-between header-about-heading">
                <h1>Articles</h1>
                <img src={arrow} />
              </div>
        ...
        <div className="mobik-nav-wrapp" onClick={()=> setShowNavbar(!showNav)}>
          <img src={bars} alt="..." />
        </div>

        <div className= {showNav ?   "mobile-nav-position" : "mobile-nav-position-not"}>
          <h1 className="navigation-first-heading-mobile">HOME</h1>
          <h1 className="navigation-first-heading-mobile">PRICING</h1>

            <h1 className="navigation-first-heading-mobile">
              RESOURCES 
            </h1>
            <h1 className="mobile-article-heading">Empowering investors with full control</h1>
            <h1 className="mobile-article-heading">Empowering investors with full control</h1>
